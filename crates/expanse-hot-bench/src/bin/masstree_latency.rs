...
//! | `probes_and_reuse` | shuffled stream, one pass, `population`-many probes; scan: `max(1000, 10⁶ / k)` starts cycled from the probe stream; hits strided across the whole sorted population, not its prefix (§8.6) |
