...
//! | `verdict` | **PASS** `[verified: RUN (21a382f3, the reference host)]`: 8-round bare-metal measurements across 100k, 1M, 10M populations, sorted and shuffled orders, with BCa 95% intervals, paired per-round ratios, and 64-op window-mean latencies (refuting 38 µs tail); runs 35419627251 and 35419631571. |
