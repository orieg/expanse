...
| **ARM Cortex-M (M4/M7)** | `thumbv7em-none-eabihf` | `#![no_std]` staticlib / embedded crate ([design #109](docs/design/32-bit-embedded.md)); C ABI measured on-target on an STM32H747I-DISCO Cortex-M7 ([harness](integrations/stm32h747/README.md), [results](docs/BENCHMARKING.md#cortex-m7-on-target)) |
