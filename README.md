...
### 3. Trie competitors: ART and HOT

Two adaptive-trie baselines are measured through the same pre-registered, interval-gated discipline (BCa 95% intervals on every cell; losses reported first). Full treatment: [`docs/benchmarks/art_comparison/`](docs/benchmarks/art_comparison/README.md) and [`docs/benchmarks/hot_comparison/`](docs/benchmarks/hot_comparison/README.md).
...
- **Write concurrency is a measured loss against HOT-ROWEX**; see the next section.
