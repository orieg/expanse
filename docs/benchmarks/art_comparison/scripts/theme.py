...
Shared dual-theme SVG styling for the ART vs Expanse benchmark comparison suite.
...
Palette:
  ...
  - blart (ART): #2563eb (light) / #3b82f6 (dark)
  - BTreeMap: #d97706 (light) / #f59e0b (dark)
  - HashMap: #7c3aed (light) / #a855f7 (dark)
"""
