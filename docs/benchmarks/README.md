...
| [`concurrency/`](concurrency/README.md) | `concurrency`, `writer_scaling`, `writer_scaling_diagnostic`, `writer_scaling_padded` | `perf stat` + wall-clock | Concurrency instruments — results |
