...
# integrations/stm32h747/README.md. Writes transcript.txt + results.json here
# and re-renders the three charts under docs/assets/.
set -eu
...
mv "$HERE/capture_clean.txt" "$HERE/transcript.txt"
mv "$HERE/capture_clean.json" "$HERE/results.json"
