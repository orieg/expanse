...
| **Pillar D: Full-Vocab Apply** | Mask Apply Latency | **Dense Bitmask** | **Expected Loss** (by construction). The previously published <0.1 µs figure came from a dead-code-eliminated loop; measurement pending re-run ([#546](https://github.com/orieg/expanse/issues/546)). |
