...
Shared dual-theme SVG styling for the LLM Inference benchmark suite (#342).
High-contrast light defaults for standalone viewers, with dark-mode overrides via
both `@media (prefers-color-scheme: dark)` and `[data-theme="dark"]` (GitHub).
"""
...
def svg_header(width: int = 960, height: int = 340, title: str = "Benchmark Chart") -> str:
  ...
  <defs>
    <style>
      ...
      .badge-loss-text {{ font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; font-size: 10px; font-weight: 700; fill: #b45309; text-anchor: middle; }}
