"""
docs/benchmarks/patricia_comparison/scripts/theme.py

Shared dual-theme SVG styling for the Patricia / radix trie vs Expanse suite.
...
Palette:
  ...
  - patricia_tree: #2563eb / #3b82f6  -- `.b-patricia`
  - fast_radix_trie: #d97706 / #f59e0b  -- `.b-radix`
  - qp-trie: #7c3aed / #a855f7  -- `.b-qp`

The chrome selectors are byte-identical to the other suites' copies, which
`scripts/check_chart_themes.py` enforces. The three twin classes are this
suite's additions; they reuse the colours the other suites give `.b-art`,
`.b-btree` and `.b-hashmap`, named for the structure each bar draws.
"""
...
def svg_header(width: int = 960, height: int = 340, title: str = "Benchmark Chart") -> str:
  ...
  <defs>
    <style>
      ...
      .t-val-loss {{ font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; font-size: 11px; font-weight: 700; fill: #b45309; }}
      ...
      @media (prefers-color-scheme: dark) {{
        ...
        .t-note {{ fill: #94a3b8; }}
        .t-val-loss {{ fill: #fbbf24; }}
        .b-expanse {{ fill: #22c55e; }}
        .b-art {{ fill: #3b82f6; }}
        .b-patricia {{ fill: #3b82f6; }}
        .b-radix {{ fill: #f59e0b; }}
        .b-qp {{ fill: #a855f7; }}
        .b-btree {{ fill: #f59e0b; }}
      ...
      :root[data-theme="dark"] .t-val-loss, [data-theme="dark"] .t-val-loss {{ fill: #fbbf24; }}
      ...
      :root[data-theme="dark"] .b-patricia, [data-theme="dark"] .b-patricia {{ fill: #3b82f6; }}
      :root[data-theme="dark"] .b-radix, [data-theme="dark"] .b-radix {{ fill: #f59e0b; }}
      :root[data-theme="dark"] .b-qp, [data-theme="dark"] .b-qp {{ fill: #a855f7; }}
