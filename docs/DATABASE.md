...
| **ART (Adaptive Radix Tree)** | 40.13–55.62 B/key *(measured: reference host, art_memory; up to 58.50 projected)* | 46.9–66.8 ns *(measured: reference host, art_lookup_hit)* | Ordered Walk | Node Version Locks (Rowex) |
