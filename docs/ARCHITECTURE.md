...
Pinning tests for these numbers are `immed_capacity_bounds` (`crates/expanse/src/types.rs:387`), `tag_spaces_are_disjoint_and_total` (`crates/expanse/src/types.rs:363`) and `immediate_payload_round_trips_all_widths` (`crates/expanse/src/trie32.rs:6695`), in addition to the doc gate.
