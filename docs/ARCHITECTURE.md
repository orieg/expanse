...
| 6. Mutation engine | insert/delete cascades + hysteresis (set flavor done incl. `ExpanseSet`; map flavor = 6b) | Property tests + invariant validator (TESTING.md) green |
