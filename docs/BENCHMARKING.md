...
| [`crates/expanse/examples/bytes_per_key_32.rs`](../crates/expanse/examples/bytes_per_key_32.rs) | 10k | N/A (Memory) | N/A | N/A | `mem_used()` accounting | Clean | Pure 32-bit census | Exact byte count | **PASS** `[verified: RUN (f48dcc6e)]`: Deterministic 32-bit memory census; re-measured after the #615 subarray cap-classing. |
